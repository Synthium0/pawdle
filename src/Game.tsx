...
let initChallenge = "";
let challengeError = false; // Just to make sure that the code doesnt get angry about challenge errors
// reason why it will get mad is because I removed the challenge link.
// this is because you can use the same link over and over, and you will get paw token for it.
